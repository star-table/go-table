...
const TableNameLcAppForm = "lc_app_form"

// LcAppForm mapped from table <lc_app_form>
type LcAppForm struct {
	...
	AppID      int64     `gorm:"column:app_id;not null;default:0" json:"app_id"`                           // 应用id
	...
	Type       int32     `gorm:"column:type;default:1" json:"type"`
}

// TableName LcAppForm's table name
func (*LcAppForm) TableName() string {
	return TableNameLcAppForm
}
